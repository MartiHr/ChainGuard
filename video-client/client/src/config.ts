...
export const IPFS_GATEWAY = process.env.VITE_IPFS_GATEWAY || "https://gateway.pinata.cloud/ipfs";
export const EXPLORER_URL = process.env.VITE_EXPLORER_URL || "http://localhost:8545";
